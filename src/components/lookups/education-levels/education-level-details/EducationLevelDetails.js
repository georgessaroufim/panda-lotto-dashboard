...
import { postGetEducationLevelById, postUpSertEducationLevel } from '../../../../core/api/Api';
...
const EducationLevelDetails = () => {
    ...
    const getEducationLevelById = () => {
        postGetEducationLevelById({ id }).then(res => {
    ...
    const onSubmit = (e) => {
        ...
        if (checkFormErrors(formErrors)) {
            ...
            postUpSertEducationLevel(data).then(res => {
                ...
                if (response) {
                    if (isNaN(id)) {
                        navigate('/education-level-details/' + response?.id)
                    }
                    setSuccess(true)
                } else {
                    setSuccess(false)
...
export default EducationLevelDetails